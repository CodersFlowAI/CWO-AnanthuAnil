...
<body>
  ...
  <section id="container" >
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo">CCA <span class="lite">Admin Portal</span></a>
      <!--logo end-->
      ...
      <section class="wrapper">
        ...
        <div class="row">          
          <div class="col-lg-7 col-md-3">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h2><i class="fas fa-folder-open"></i><strong>Case Files </strong></h2>
              ...
              <div class="panel-body-map" style="height: 423px!important;">
                <div id="map" style="height: 100%">
                  <iframe src="casefiles.php" scrolling="form-horizontal" class="col-lg-12 col-md-12" height="83%"></iframe>
                </div>
          ...
          <div class="col-lg-5 col-md-8">
            <div class="panel panel-default">
              ...
              <div class="panel-body-map" style="height: 423px!important;">
                <div id="map" style="height: 100%">
                  <iframe src="map.html" scrolling="no" class="col-lg-12 col-md-12" height="100%"></iframe>
                </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-12">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h2><i class="fa fa-flag-o red"></i><strong>Agent Performance</strong></h2>
                <div class="panel-actions">
                  <a href="index.html#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
                  <a href="index.html#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
                  <a href="index.html#" class="btn-minimize"><i class="fa fa-times"></i></a>
        ...
        <div class="row">
          ...
          <div class="col-md-6 portlets">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h2><i class="fa fa-map-marker red"></i><strong>Quick Post </strong></h2>
                <div class="panel-actions">
                  <a href="index.html#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
                  <a href="index.html#" class="btn-minimize"><i class="fa fa-times"></i></a>
                </div>
